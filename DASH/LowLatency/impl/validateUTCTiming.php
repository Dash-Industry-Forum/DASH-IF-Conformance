...
$logger->test(
    ...
    "Section 9.X.4.2",
    "'At least one UTC timing description SHALL be present and be restricted with @schemeIdUri set to one of " .
    "{urn:mpeg:dash:utc:http-xsdate:2014, urn:mpeg:dash:utc:http-iso:2014, urn:mpeg:dash:utc:http-ntp:2014}'",
    $utc_timings != null,
    "FAIL",
