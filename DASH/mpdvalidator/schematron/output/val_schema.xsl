...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--RULE -->
   <xsl:template match="dash:MPD" priority="1000" mode="M21">
   ...
   <!--RULE -->
   <xsl:template match="dash:Period" priority="1000" mode="M22">
   ...
   <!--RULE -->
   <xsl:template match="dash:AdaptationSet" priority="1000" mode="M23">
   ...
   <!--RULE -->
   <xsl:template match="dash:ContentComponent" priority="1000" mode="M24">
   ...
   <!--RULE -->
   <xsl:template match="dash:Representation" priority="1000" mode="M25">
   ...
   <!--RULE -->
   <xsl:template match="dash:SubRepresentation" priority="1000" mode="M26">
   ...
   <!--RULE -->
   <xsl:template match="dash:SegmentTemplate" priority="1000" mode="M27">
   ...
   <!--RULE -->
   <xsl:template match="dash:SegmentList" priority="1000" mode="M28">
   ...
   <!--RULE -->
   <xsl:template match="dash:SegmentTimeline" priority="1000" mode="M30">
   ...
   <!--RULE -->
   <xsl:template match="dash:ProgramInformation" priority="1000" mode="M31">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="dash:Role" priority="1000" mode="M33">
   ...
   <!--RULE -->
   <xsl:template match="dash:FramePacking" priority="1000" mode="M34">
   ...
   <!--RULE -->
   <xsl:template match="dash:AudioChannelConfiguration" priority="1000" mode="M35">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="dash:EventStream" priority="1000" mode="M36">
   ...
   <!--RULE -->
   <xsl:template match="dash:Subset" priority="1000" mode="M37">
   ...
   <!--RULE -->
   <xsl:template match="dash:UTCTiming" priority="1000" mode="M38">
   ...
   <!--RULE -->
   <xsl:template match="dash:SupplementalProperty" priority="1000" mode="M39">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="dash:Period" priority="1001" mode="M40">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="dash:Period"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">MPD element</svrl:text>
   <!--RULE -->
   <xsl:template match="dash:MPD" priority="1000" mode="M41">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="dash:MPD"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Period element</svrl:text>
   <!--RULE -->
   <xsl:template match="dash:Period" priority="1000" mode="M42">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="dash:Period"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">AdaptationSet element</svrl:text>
   <!--RULE -->
   <xsl:template match="dash:AdaptationSet" priority="1000" mode="M43">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="dash:AdaptationSet"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Representation element</svrl:text>
   <!--RULE -->
   <xsl:template match="dash:Representation" priority="1000" mode="M44">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="dash:Representation"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">SubRepresentation element</svrl:text>
   <!--RULE -->
   <xsl:template match="dash:SubRepresentation" priority="1000" mode="M45">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="dash:SubRepresentation"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">SegmentBase element</svrl:text>
   <!--RULE -->
   <xsl:template match="dash:SegmentBase" priority="1000" mode="M46">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="dash:SegmentBase"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">ContentProtection element</svrl:text>
   <!--RULE -->
   <xsl:template match="dash:ContentProtection" priority="1000" mode="M47">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="dash:ContentProtection"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">AudioChannelConfiguration element</svrl:text>
   <!--RULE -->
   <xsl:template match="dash:AudioChannelConfiguration" priority="1000" mode="M48">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="dash:AudioChannelConfiguration"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="dash:EssentialProperty" priority="1000" mode="M49">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
