...
class Profiles
{
    ...
    private function validateSubProfiles(ProfileSpecificMPD $profileSpecificMPD): void
    {
        foreach ($profileSpecificMPD->representations as $representation) {
            $liveXorOnDemand = $representation->hasProfile("urn:dvb:dash:profile:dvb-dash:isoff-ext-live:2014") xor
                               $representation->hasProfile("urn:dvb:dash:profile:dvb-dash:isoff-ext-on-demand:2014");
