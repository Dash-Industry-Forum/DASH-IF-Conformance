...
<!--PROLOG-->
<xsl:output xmlns:schold="http://www.ascc.net/xml/schematron"
...
<xsl:template match="dash:MPD" priority="1000" mode="M6">
      <svrl:fired-rule xmlns:schold="http://www.ascc.net/xml/schematron"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="dash:MPD"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:schold="http://www.ascc.net/xml/schematron"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
