...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <link rel="STYLESHEET" type="text/css" href="../Utils/tree/dhtmlxTree/codebase/dhtmlxtree.css">
    <script type="text/javascript" src="../Utils/tree/dhtmlxTree/codebase/dhtmlxcommon.js"></script>
    <script type="text/javascript"  src="../Utils/tree/dhtmlxTree/codebase/dhtmlxtree.js"></script>
    <script type="text/javascript" src="../Utils/tree/dhtmlxTree/codebase/ext/dhtmlxtree_json.js"></script>
...
<div class="page-wrap">    
    <div class="container">
        ...
        <img src="../Utils/img/settings.jpg" class="settings_img" id="settings_img"  width="45" height="45" />
        </button>  
    ...
    <div id="dash">
        <br>
        <img id="img2" border="0" src="../Utils/dash_img/dashlogo.jpeg" alt ="DASH Conformance" width="543" height="88" >
        <img id="img2" border="0" src="../Utils/dash_img/Dash1.jpeg" width="191" height="61" >
        <br>    <br>
    </div>
